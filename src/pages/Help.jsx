...
import { sendHelpMessage,resetHelpstate } from '../store/help/helpSlice';
...
function Help() {
    ...
    const sendEmail = (e) => {
      ...
      fData.append("captcha", captchaValue);
    };
  ...
  return (
    <section className=" bg-no-repeat"  style={{ backgroundImage: `url(${bg2})` }}>
 
  <h2 className="text-center mb-5 text-5xl  text-white sm:text-[40px]/[48px] md:text-center block font-extrabold  underline  decoration-[#79df13] underline-offset-8 py-5">
              Help Desk Enquiry
            </h2>

  <div className="max-w-screen-lg mx-auto p-5" data-aos="zoom-in">
    <div className="grid grid-cols-1 md:grid-cols-12 border">
        <div className="bg-gray-900 md:col-span-4 p-10 text-white">
            ...
            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                Get In <span className="text-[#67f529]">Touch</span>
            </h3>
            <p className="mt-4 leading-7 text-gray-200">
            Established 2009 in the Middle East, Exceed NetSec specializes in advanced IT security and network solutions. Our company focuses on strengthening IT infrastructures for organizations through services such as email security, network enhancement, disaster recovery strategies and managed services. With our deep industry experience, Exceed NetSec aims to protect clients against evolving cyber threats, ensuring secure and seamless IT operations.
            </p>
            ...
            <div className="flex items-center mt-5">
                ...
                <span className="text-sm">Acico Building Office #821 Port Dubai PostBox 121092</span>
            </div>
            <div className="flex items-center mt-5">
                <svg className="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 60.002 60.002"   style={{ enableBackground: 'new 0 0 60.002 60.002' }} xml:space="preserve">
                    <g>
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                ...
                <span className="text-sm"> +91 971 555 696 711</span>
            </div>
            <div className="flex items-center mt-5">
                <svg className="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 300.988 300.988"   style={{ enableBackground: 'new 0 0 60.002 60.002' }}
                    xml:space="preserve">
                    <g>
                        <g>
        ...
        <form className="md:col-span-8 p-10" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    onChange={(e)=>setcompanyname(e.target.value)}
                        ...
                        id="conpany" type="text" placeholder="your company name"/>
                </div>
                <div className="w-full px-3">
                    <label className="block uppercase tracking-wide text-white text-xs font-bold mb-2"
                        for="grid-password">
                    ...
                    onChange={(e)=>setemail(e.target.value)}
                        className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        id="grid-email" type="email" placeholder="your@gmail.com"/>
                </div>
            </div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <button
                        className="right-0 shadow bg-indigo-600 hover:bg-indigo-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                        type="submit">
                        Send Message
                    </button>

        </form>
        <div className="w-full  lg:translate-y-[-7rem] lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-blue-900 rounded-2xl hidden lg:block">
