...
const NavBar = () => {
    ...
    return (
        ...
        <p class='text-sm'><strong class="mx-3">Address:</strong>SWF New York 185669<strong class="mx-3">Contact
                        ...
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-10 lg:mt-0 text-center sm:text-none text-xl">
                            <li>
                                <NavLink
                                    ...
                                    lassName={({ isActive }) =>
                                        `block py-2 pl-3 pr-4 rounded lg:bg-transparent lg:p-0 ${isActive ? 'text-green-500 underline decoration-4  underline-offset-8 d decoration-green-500' : 'text-gray-700'
                                        }`
                                    }
                                    aria-current="page"
                                >
                            ...
                            <li>
                                <NavLink
                                    ...
                                    onClick={handleClose}
                                    className={({ isActive }) =>
                                        `block py-2 pl-3 pr-4 rounded lg:bg-transparent lg:p-0 ${isActive ? 'text-green-500 underline decoration-4  underline-offset-8 bg-green-700 ' : 'text-gray-700'
                                        }`
                                    }
                                >
                                    Specialization
            ...
            <section className="py-1 bg-green-500 text-black text-center px-10 z-60">
                <div className="flex justify-center items-center text-sm">
                    <p
                        className="text-3xl sm:text-3xl ml-10"
