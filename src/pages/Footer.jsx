                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full ">
                        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                            ...
                            {/* <p class="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">Established 2009 in the Middle East, Exceed NetSec specializes in advanced IT security and network solutions. The company focuses on strengthening IT infrastructures for organizations through services like email security</p> */}
                            <div class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                                <a href="javascript:;" class="w-9 h-9 rounded-full bg-[#67F529] flex justify-center items-center ">
                                    <svg class="text-black" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <g id="Social Media">
                                ...
                                <a href="javascript:;" class="w-9 h-9 rounded-full bg-[#67F529] flex justify-center items-center ">
                                    <svg class="w-[1.25rem] h-[1.125rem] text-black" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="javascript:;" class="w-9 h-9 rounded-full bg-[#67F529] flex justify-center items-center ">
                                    <svg class="w-[1rem] h-[1rem] text-black" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="javascript:;" class="w-9 h-9 rounded-full bg-[#67e930] flex justify-center items-center ">
                                    <svg class="w-[1.25rem] h-[0.875rem] text-black" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="py-7 border-t border-gray-200">
                        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                            <span class="text-sm text-white "> © Copy rights Exceeded Netsec 2024 All rights reserved.</span>
