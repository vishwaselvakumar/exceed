    ...
    <div>
      {serviceCard && (
        <>
          ...
          {/* Option 1: Use inline style to enforce white-space */}
          {/* <p style={{ whiteSpace: 'pre-wrap' }}>{serviceCard.description}</p> */}

          {/* Option 2: Convert newline characters to <br /> tags */}
          {/* <p>
            {serviceCard.description.split('\n').map((line, index) => (
